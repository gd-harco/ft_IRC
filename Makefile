...
SRC = main.cpp channel.cpp client.cpp server.cpp commands/CommandsExceptions.cpp commands/User.cpp commands/Pass.cpp commands/Nick.cpp commands/Join.cpp commands/Privmsg.cpp commands/Part.cpp
